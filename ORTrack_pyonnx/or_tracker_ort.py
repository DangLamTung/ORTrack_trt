...
class ORTrackerORT:
    ...
    def track(self, image, info: dict = None):
        ...
        ort_inputs = {'template': self.to_numpy(self.template), 'search': self.to_numpy(search)}
...
if __name__ == '__main__':
    ...
    model_path = "model/model_ortrack_distill_sim.onnx"
    Tracker = ORTrackerORT(model_path = model_path, fp16=False)
    first_frame = True
